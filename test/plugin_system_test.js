...
describe('php_basic_test', () => {
  ...
  it('日時処理', () => {
    ...
    cmp('「2021/01/01」から「2022/01/01」までの年数差を表示。', '1')
    cmp('「2021/01/01」から「2023/01/01」までの年数差を表示。', '2')
    cmp('「2021/01/01」から「2021/02/01」までの月数差を表示。', '1')
    cmp('「2021/01/01」から「2021/03/01」までの月数差を表示。', '2')
    cmp('「2021/01/01」から「2021/02/02」までの月数差を表示。', '1')
    cmp('「2021/01/01」から「2021/03/02」までの月数差を表示。', '2')
    cmp('「00:00:00」に「+00:00:05」を時間加算して表示', '00:00:05')
  })
})
